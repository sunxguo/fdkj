...
Author: Wuya
Homepage: http://heiniaozhi.cn Github: https://github.com/doubletong/jQuerypulgins
*/
(function ($) {
    ...
    $.fn.bbiSlider = function (opts) {
        ...
        if (options.dotNav) {
            ...
            links.click(function (e) {
                ...
                slider.chang(linkIndex, lis, links); //鍒囨崲鍥剧墖
    ...
    var slider = {
        initialize: function (slider,lis) { //initialize slider
            ...
            var prevNext = '<a href="#" class="prev"><div class="iconprev"></div></a><a href="#" class="next"><div class="iconnext"></div></a>';
...
(function($) {   
   ...
   $.fn.bbiTab = function(opts){
        ...
        var defaults = {
            currentIndex: 1 // 褰撳墠绱㈠紩
        };
        var options = $.extend(defaults, opts);
       
       var lis = $(this).find('nav.tab-header a');
       var tabs = $(this).find('div.tab-body section.epibole-page');
